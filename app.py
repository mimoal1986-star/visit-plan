        ...
        if "🗺️ Карта полигонов" in available_tabs:
            with results_tabs[tab_index]:
                ...
                with col1:
                    ...
                    if st.button("🗺️ Выгрузить KML файл", type="primary", use_container_width=True, key="kml_export"):
                        try:
                            import simplekml
                            # Создаем KML файл
                            kml = simplekml.Kml()
                ...
                with col2:
                    ...
                    if st.button("📊 Выгрузить для Google Карт", type="primary", use_container_width=True, key="google_maps_export"):
                        try:
